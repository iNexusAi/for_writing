...
if __name__ == "__main__":
    ...
    test_instruction = "Write a 1500-word essay about the impact of artificial intelligence on modern society"
    test_plan = "Paragraph 1 - Main Point: Introduction to AI and its growing influence - Word Count: 200 words"
    test_text = "Artificial Intelligence (AI) has become an integral part of our modern society"
    
    # Invoke the write_chain with correct spelling
